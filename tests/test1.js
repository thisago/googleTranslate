...
function tokenApplySecret_11682121(key_11682123, secret_11682124) {
  var result_11682125 = 0;

    var i_11682127 = 0;
    result_11682125 = key_11682123;
    L1: do {
      var __11682135 = 0;
      var colontmp__11710080 = 0;
      colontmp__11710080 = ((secret_11682124).length - 2);
      var i_11710081 = 0;
      L2: do {
          L3: while (true) {
          if (!(i_11710081 < colontmp__11710080)) break L3;
            __11682135 = i_11710081;
            var ch_11682136 = secret_11682124[(i_11682127 + 2)];
            var chInt_11682138 = ch_11682136;
            if ((97 <= chInt_11682138)) {
            chInt_11682138 -= 87;
            }
            else {
              chInt_11682138 = nsuParseInt(nimCharToStr(ch_11682136));
            }
            
            if ((secret_11682124[(i_11682127 + 1)] == 43)) {
            chInt_11682138 = lshr_11685010(result_11682125, chInt_11682138);
            }
            else {
              chInt_11682138 = lshl_11685034(result_11682125, chInt_11682138);
            }
            
            if ((secret_11682124[i_11682127] == 43)) {
            result_11682125 = (result_11682125 + chInt_11682138);
            }
            else {
              result_11682125 = (result_11682125 ^ chInt_11682138);
            }
            ...
            i_11682127 += 3;
            if (((secret_11682124).length <= i_11682127)) {
            break L1;
            }
    ...
    L5: do {
      ...
      L6: do {
          ...
          if (!(i_11710072 < L_11710073)) break L7;
            ...
            key_11690191 = tokenApplySecret_11682121(key_11690191, makeNimstrLit("+-a^+6"));
            i_11710072 += 1;
          }
      } while(false);
    } while(false);
    key_11690191 = tokenApplySecret_11682121(key_11690191, makeNimstrLit("+-3^+b+-f"));
...
L1: do {
  L2: do {
    ...
    L3: do {
        L4: while (true) {
        if (!true) break L4;
          str_11701069[0] = TO_TEST_11701019[i_11710059];
          var nim_11701070 = newApiToken_11690014(str_11701069[0]);
          var js_11701071 = mod.newKey(toJSStr(str_11701069[0]));
          if ((toJSStr(nim_11701070) == js_11701071)) {
          ...
          var color_11701073 = nimCopy(null, Tmp5, NTI2378013);
          var fmtRes_11701081 = [mnewString(0)];
          formatValue_11610080(fmtRes_11701081, 0, nim_11701070, []);
          fmtRes_11701081[0].push.apply(fmtRes_11701081[0], makeNimstrLit(" == "));;
          add_2547211(fmtRes_11701081, 0, js_11701071);
          fmtRes_11701081[0].push.apply(fmtRes_11701081[0], makeNimstrLit(" "));;
          formatValue_11710003(fmtRes_11701081, 0, (toJSStr(nim_11701070) == js_11701071), []);
          rawEcho(color_11701073, fmtRes_11701081[0]);
          if ((8 <= i_11710059)) {
          break L3;
          }
